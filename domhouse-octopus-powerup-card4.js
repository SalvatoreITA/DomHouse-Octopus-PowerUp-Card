console.info("%c 🐙 DOMHOUSE OCTOPUS POWERUP CARD v1.3.0 IS LOADED ", "color: white; background: #00d1ff; font-weight: bold; border: 1px solid white; padding: 2px 6px; border-radius: 4px;");
...
class DomHouseOctopusPowerupCardEditor extends LitElement {
  ...
  _valueChanged(ev) {
    ...
    // Per i selettori booleani (ha-selector) il valore arriva in detail.value
    ...
    return html`
      <div class="card-config">
        <div class="vertical-inputs">
            <ha-textfield label="Titolo Card (lascia vuoto per nasconderlo)" .value=${this._config.title !== undefined ? this._config.title : '🐙 Octopus PowerUp Helper'} .configValue=${"title"} @input=${this._valueChanged}></ha-textfield>
